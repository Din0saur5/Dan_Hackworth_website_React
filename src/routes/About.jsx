...
const About = () => {
  return (
    <div className='deep'>
      ...
      <Figure.Image
        style={{"border": "2px solid #dddbdbec"}}
        width={190}
        height={210}
        alt="profile picture"
        src='../../public/Photos/profile-picture.jpeg'
      />
      </Figure>
      
        <br/><br/>
      <article className='about-text'>
      &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;My name is Daniel Hackworth. I'm 26 years old,
      ...
      I am proficient in several coding languages but more on that later.
       I earned my Associate of Science degree in Horticulture from the 
       ...
       crafting costumes, and spending time with my dog, Kali. Cooking and fitness
        ...
        For the past two years, I've been a dedicated dog walker and pet sitter.
        ...
        and starting a family. This motivates me to explore new career paths that align with
          ...
          the robotics team. However, the real turning point came later when I faced a challenge – 
          ...
          My first coding success was a comprehensive bookkeeping program crafted with JavaScript and Google
           Apps Script, featuring integrated APIs. This ignited my passion, leading to personal Python projects. 
